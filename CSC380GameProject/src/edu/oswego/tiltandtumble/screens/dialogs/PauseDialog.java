...
public class PauseDialog extends Dialog {
	...
	private final MultiplayerGameScreen multiplayerScreen;
	...
	public PauseDialog(String title, Skin skin, MultiplayerGameScreen screen, final TiltAndTumble game) {
		super(title, skin, "dialog");
		...
		if (object != null && object instanceof Buttons) {
			if(screen != null){
				...
				if (b == Buttons.QUIT) {
					...
					multiplayerScreen.loadLevel(multiplayerScreen.getCurrentLevel().getLevelNumber());
				} else if (b == Buttons.CONTINUE) {
					multiplayerScreen.resume();
				}	
			}
		}	
	}
